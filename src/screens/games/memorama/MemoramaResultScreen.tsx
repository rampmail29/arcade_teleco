...
type Props = NativeStackScreenProps<RootStackParamList, 'MemoramaResult'>;

export default function MemoramaResultScreen({ navigation, route }: Props): React.JSX.Element {
